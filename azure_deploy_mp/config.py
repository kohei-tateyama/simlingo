...
# Environment & compute defaults
ENV_NAME = os.environ.get("AZ_ENV_NAME", "AzureML-pytorch-2.2-cuda12.1-gpu")
DEFAULT_SKU = os.environ.get("AZ_COMPUTE_SKU", "Standard_NC16as_T4_v3")
DEFAULT_MIN_INSTANCES = int(os.environ.get("AZ_MIN_INSTANCES", "0"))
DEFAULT_MAX_INSTANCES = int(os.environ.get("AZ_MAX_INSTANCES", "1"))
DEFAULT_IDLE_TIME = int(os.environ.get("AZ_IDLE_SECONDS", "1800"))

# Default batch size and SKU->GPU mapping
DEFAULT_BATCH = int(os.environ.get("DEFAULT_BATCH", "4"))
SKU_GPU_MAP = {
