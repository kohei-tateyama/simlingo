...
from leaderboard21.scenarios.scenario_manager_local import ScenarioManager
from leaderboard21.scenarios.route_scenario import RouteScenario
from leaderboard21.envs.sensor_interface import SensorConfigurationInvalid
from leaderboard21.autoagents.agent_wrapper_local import AgentError, validate_sensor_configuration
from leaderboard21.utils.statistics_manager_local import StatisticsManager, FAILURE_MESSAGES
from leaderboard21.utils.route_indexer import RouteIndexer
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            if getattr(agent_class_obj, 'get_ros_version')() == 1 and self._ros1_server is None:
                from leaderboard21.autoagents.ros1_agent import ROS1Server
