...
def main(cfg: TrainConfig):
    ...
    ######### load checkpoints ############
    #######################################
    load_path = '/workspace/simlingo/outputs/simlingo2/checkpoints/epoch=013.ckpt'
    ...
    print("\n\n\n\n\n")
    print("cfg.data_module:", cfg.data_module)
    print("\n\n\n\n\n")
    ...
    if load_path is not None:
        ...
        print("after if predict")
    else:
        print("else")
        trainer.predict(model, data_module)
        print("after else predict")
