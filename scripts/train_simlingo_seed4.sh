...
WANDB__SERVICE_WAIT=300 python simlingo_training/train.py experiment=simlingo_seed4 data_module.batch_size=1 gpus=1 name=simlingo_seed4



# source scripts/train_simlingo_seed4.sh > train_seed4.log 2>&1