...
def create_video_from_images(image_dir, output_video=None, fps=20):
    ...
    if output_video is None:
        output_video = image_dir.parent / f"{image_dir.name}_video_2fps.mp4"
    else:
...
if __name__ == "__main__":
    ...
    # default_pattern = "/workspace/simlingo/database/simlingo_carla0916_2_/training_3_scenarios/routes_devtest/random_weather_seed_42_balanced_100/Town03_Rep1_route24206_02_05_15_56_38/rgb_inf_done"
    # default_pattern = "/workspace/simlingo/database/simlingo_carla0916_2_/training_3_scenarios/routes_devtest/random_weather_seed_42_balanced_100/Town03_Rep1_route24816_02_05_16_33_41/rgb_inf_done"
    
    default_pattern = "/workspace/simlingo-kohei/data/output_simlingo"
    ...
    if len(sys.argv) > 2:
        ...
        fps = 3  # Default to 20 FPS (CARLA frame rate)
