...
## Super basic usage.
# # single autopilot
# bash run_carla_autopilot.sh --mode autopilot --duration 10 --route highway 
# # all autopilot variations
# bash run_carla_autopilot.sh --mode autopilot --autopilot-all
...
OPTIONS:
    ...
    -m, --mode MODE         Simulation mode (default: evaluation)
                           Options:
                             - evaluation: Run Bench2Drive evaluation
